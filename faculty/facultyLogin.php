		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Faculty Sign In</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Have an account?</h3>
		      		...
		      		<div class="form-group">
		      			<input type="email" class="form-control rounded-left" name="admin_email" placeholder="example@gmail.com" required>
		      		</div>
	            <div class="form-group d-flex">
	              <input type="password" class="form-control rounded-left" name="admin_pwd" placeholder="Password" required>
	            </div>
